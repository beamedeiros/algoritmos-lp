...
#João precisa que você faça um programa que leia a variável peso (peso de peixes) e verifique
#se há excesso. Se houver, gravar na variável excesso e na variável multa o valor da multa que 
